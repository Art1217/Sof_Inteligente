...
@Composable
fun GraficPLNScreen(navController: NavHostController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            val image = painterResource(id = R.drawable.curvapln)
            ...
            val image3 = painterResource(id = R.drawable.perdidapln)
            Image(
                painter = image3,
                contentDescription = null,
            ...
            Spacer(modifier = Modifier.padding(10.dp))
            val image4 = painterResource(id = R.drawable.precisionpln)
            Image(
                painter = image4,
                contentDescription = null,
                contentScale = ContentScale.FillBounds,
...
@Composable
@Preview
fun PreviewGraficPLN(){
    val navController = rememberNavController()
    GraficPLNScreen(navController)
}