...
@Composable
fun GraficCIScreen(navController: NavHostController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            val image = painterResource(id = R.drawable.curvaci)
            ...
            val image2 = painterResource(id = R.drawable.precisionci)
            Spacer(modifier = Modifier.padding(10.dp))
            Image(
                painter = image2,
                contentDescription = null,
            ...
            Spacer(modifier = Modifier.padding(10.dp))
            val image3 = painterResource(id = R.drawable.perdidaci)
            Image(
                painter = image3,
                contentDescription = null,
                contentScale = ContentScale.FillBounds,
